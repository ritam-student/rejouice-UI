...
export default function OurApproach() {
    ...
    return <div className="approach h-auto w-full bg-white text-black py-5">
        {/**  part 1   */}
        <div className=" w-full h-auto flex items-center justify-between gap-4 py-48 px-6 md:px-8 lg:px-10 ">
        ...
        <div>
            <div className="px-6 md:px-8 lg:px-10 w-auto h-auto flex items-center justify-between py-6 md:text-xl">
            ...
            {/**  moving slides  */}
            <div className="h-auto w-full  flex items-start justify-between gap-5 overflow-x-auto cursor-grab">
                <div className=" rounded-lg overflow-hidden w-[250px] h-[300px] md:w-[400px] lg:w-[460px] lg:h-[500px] shrink-0 md:h-[400px] object-cover object-center  ">
                ...
                <div className=" rounded-lg overflow-hidden w-[270px] h-[195px] md:w-[450px] lg:w-[510px] lg:h-[400px] shrink-0 md:h-[300px] text-white bg-black ">
                    <div className="flex flex-col justify-between px-[10%] py-[10%] h-full w-full md:text-xl lg:text-2xl">
                        <div>
                ...
                <div className=" rounded-lg overflow-hidden w-[270px] h-[180px] md:w-[450px] lg:w-[510px] lg:h-[400px] shrink-0 md:h-[300px] text-black bg-[#F7F7F7] ">
                    <div className="flex flex-col justify-between px-[10%] py-[10%] h-full w-full md:text-xl lg:text-2xl">
                        <div>
                            <p>Driving 150%</p>
                ...
                <div className="rounded-lg overflow-hidden w-[250px] h-[320px] md:w-[400px] lg:w-[460px] lg:h-[520px] shrink-0 md:h-[420px] ">
                    <div className="relative  overflow-hidden w-full h-full">
                        <video src="/video/smallvideo.mp4" muted autoPlay loop className="w-full h-full object-cover"></video>
                        <div className="absolute inset-0 text-white px-[10%] py-[10%] flex justify-between w-full h-full md:text-2xl">
                ...
                <div className=" rounded-lg overflow-hidden w-[270px] h-[195px] md:w-[450px] lg:w-[510px] lg:h-[400px] shrink-0 md:h-[300px] text-black bg-[#F7F7F7] ">
                    <div className="flex flex-col justify-between px-[10%] py-[10%] h-full w-full md:text-xl">
                        <div>
