    ...
    return <div className="pt-10 md:pt-20 lg:pt-32 ">
        ...
        <div className="w-full h-auto text-xl md:text-3xl">
            <div className="flex items-start justify-start w-full h-auto py-5 mt-4 border-t-[1px] border-gray-400 ">
                <div className="w-1/2 h-auto"><h3 className="h-auto w-[65%] md:w-[50%]">A simple philosophy: quality over quantity.</h3></div>
            ...
            <div className="flex items-start justify-start w-full h-auto py-5 mt-4 border-t-[1px] border-gray-400 ">
                <div className="w-1/2 h-auto"><h3 className="h-auto w-[65%] md:w-[50%]">Performance & emotion. You need both.</h3></div>
        ...
        <div className="w-full h-auto  text-center text-2xl md:text-3xl lg:text-4xl">
            <div onMouseOver={pushTextUp} onMouseLeave={pushTextDown} className="cursor-pointer box w-auto h-[60px] overflow-hidden text-center inline-block">
